...
The goal of this repo is to gather functions to use efficiently FFT (Fast Fourier Transform) transformation, even for sets of data with non uniform timestep
